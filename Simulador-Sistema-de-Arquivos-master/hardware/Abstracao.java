...
public class Abstracao {
	...
	public static String alteraPai(String binario, int novoPai) {
		return binario.substring(0, 119) + ""
				+ completaTamanho(Binario.intToBinaryString(novoPai, Configuracao.getEndereco()),
						Configuracao.getEndereco())
				+ "" + binario.substring(140, 512);
	}

	public static String alteraPonteiro(String binario, int novoEndereco) {
		return binario.substring(0, 2) + ""
				+ completaTamanho(Binario.intToBinaryString(novoEndereco, Configuracao.getEndereco()),
						Configuracao.getEndereco())
	...
	public static String setConteudo(String bloco, String conteudo) {
		return bloco.substring(0, 169) + completaTamanho(conteudo, Configuracao.getConteudoBlocoA())
				+ bloco.substring(484, 512);
	}
