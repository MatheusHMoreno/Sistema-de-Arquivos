...
public class HardDisk {
	...
	public HardDisk(Integer tamanhoDaMemoriaSecundaria) {
		...
		setAtual(0);
		// inicializa a memoria secundaria
		inicializarMemoriaSecundaria();
	}

	// funcao para obter o numero de blocos
	public int getBlocos() {
		return enderecamentoTamanho;
	}

	// inicializa a memoria secundaria com bits falsos
	...
	// Função para buscar um bloco de bits a partir de uma posição
	...
	// Função para converter uma string em um bloco de bits
	...
	// funcao para converter um bloco de bits em uma string
	...
	// funcao para definir um bloco a partir de uma string
	...
	// funcao para buscar uma posicao livre no disco
	...
	// funcao para definir um bit em uma posicao especifica
	public void setBitDaPosicao(boolean bit, int posicao) {
		this.hardDisk[posicao] = bit;
	}

	// funcao para obter um bit em uma posicao especifica
	...
	// funcao para imprimir os blocos ocupados
	...
	// funcao para calcular a posicao real de um bloco
